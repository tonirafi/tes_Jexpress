...
class LayoutSwitchAnimation(val frontView: View, val backFrontView: View) {
    ...
    private val layoutSwitchAnimGroup by lazy {
        val rightOutSet = AnimatorInflater.loadAnimator(
            frontView.context,
            R.animator.card_anim_out
        ) as AnimatorSet
        val leftInSet =
            AnimatorInflater.loadAnimator(frontView.context, R.animator.card_anim_in) as AnimatorSet
