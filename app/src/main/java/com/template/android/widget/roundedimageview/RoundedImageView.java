package com.template.android.widget.roundedimageview;
...
public class RoundedImageView extends AppCompatImageView {
    ...
    private float DEFAULT_ASPECT_RATIO = 0f; //宽高比
    ...
    public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        DEFAULT_ASPECT_RATIO = a.getFloat(R.styleable.RoundedImageView_riv_aspect_ratio, DEFAULT_ASPECT_RATIO);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (DEFAULT_ASPECT_RATIO == 0) return;
        ...
        if (widthMode == MeasureSpec.EXACTLY) {
            setMeasuredDimension(widthSize, (int) (widthSize * DEFAULT_ASPECT_RATIO));
            return;
        }
        ...
        if (heightMode == MeasureSpec.EXACTLY) {
            setMeasuredDimension((int) (heightSize / DEFAULT_ASPECT_RATIO), heightSize);
        }
    ...
    public RoundedImageView setDefaultAspectRatio(float ratio) {
        this.DEFAULT_ASPECT_RATIO = ratio;
        invalidate();
        return this;
    }
}
