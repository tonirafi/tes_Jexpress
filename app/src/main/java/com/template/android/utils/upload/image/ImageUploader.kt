...
import com.template.android.utils.upload.BitmapRotator
import com.template.android.utils.upload.MyImagePreprocessChain
...
//                .option("eager", "c_scale,w_150") //此处 eager 不会覆盖upload_preset中定义的eager 上传成功会除了返回upload_preset中的eager产生的URL 还会返回此处的eager所变换URL
            ...
            .preprocess(
                MyImagePreprocessChain.limitDimensionsChain(
                    2000,
                    2000,
                    BitmapRotator(uploadBean.imgPath)
                )
