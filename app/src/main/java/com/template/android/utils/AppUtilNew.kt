...
import com.template.android.widget.UploadImageViewGroup
...
class AppUtilNew {
    ...
    companion object {
        ...
        @JvmStatic
        fun setRecycleViewGlobal(
            context: Context,
            rv: RecyclerView,
            provider: ItemViewProvider<*, *>,
            listArrayBaseCard: List<BaseCard>,
            spanCount: Int,
            devidertWithdDp: Int
        ): CardAdapter {
            var adapter: CardAdapter? = null
            val gridLayoutManager: GridLayoutManager =
                UploadImageViewGroup.InnerGridLayoutManager(context, spanCount)
