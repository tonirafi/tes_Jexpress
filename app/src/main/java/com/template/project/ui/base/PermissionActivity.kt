...
abstract class PermissionActivity : BaseActivity(), PermissionListener, RationaleListener {
    ...
    fun hasPermissions(vararg permissions: String): Boolean = AndPermission.hasPermission(this, *permissions)
...
//                        .show()
                ...
                val snackbar = Snackbar.make(this.window.decorView, getHint(permissions[0]), BaseTransientBottomBar.LENGTH_INDEFINITE)
//                snackbar.setActionTextColor(ContextCompat.getColor(this, android.R.color.black))
                snackbar.view.setBackgroundColor(ContextCompat.getColor(this, android.R.color.black))
                snackbar.setAction("Settings") { AndPermission.defineSettingDialog(this, 400).execute() }
                snackbar.show()
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == 400) {
            ...
            if (mPermissions != null && AndPermission.hasPermission(this, Arrays.asList(*mPermissions!!)))
                permissionGranted(this.mRequestCode)
//            else {
//                isCalling = false
//            }
