...
interface CurrencyTextWatcher {
    fun onTextChanged(currencyVal: Double, currencyText: String)
}
...
class CurrencyInputWatcher(
    ...
    var textWatcher: CurrencyTextWatcher? = null
    ...
    override fun afterTextChanged(s: Editable) {
        ...
        try {
            ...
            if (hasDecimalPoint) {
                ...
                textWatcher?.onTextChanged(parsedNumber.toDouble(), newText)
            } else {
